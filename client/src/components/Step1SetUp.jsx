...
function Step1SetUp({ onStart }) {
    ...
    return (
        <motion.div
            ...
            className='flex-1 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4 py-10'>
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='relative' ref={roleRef}>
                            <FaUserTie className='absolute top-4 left-4 text-gray-400 z-10' />
                            ...
                            {showRoleSuggestions && filteredRoles.length > 0 && (
                                <motion.div
                                    ...
                                    className='absolute w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden'
                                >
                                    {filteredRoles.map((r, index) => (
                                        <div
                                            ...
                                            className='px-6 py-3 hover:bg-green-50 hover:text-green-700 cursor-pointer transition text-sm text-gray-700 border-b border-gray-50 last:border-none flex items-center gap-3'
                                        >
                                            <FaUserTie className="text-gray-300 text-xs" />
                                            {r}
                                        </div>
                                    ))}
                                </motion.div>
                        ...
                        <div className='relative' ref={dropdownRef}>
                            <FaBriefcase className='absolute top-4 left-4 text-gray-400 z-10' />
                            
                            <div 
                                onClick={() => setShowExperienceDropdown(!showExperienceDropdown)}
                                className='w-full pl-12 pr-10 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition cursor-pointer flex justify-between items-center bg-white'
                            >
                                <span className={experience ? 'text-gray-800' : 'text-gray-400'}>
                            ...
                            {showExperienceDropdown && (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -10 }}
                                    transition={{ duration: 0.2 }}
                                    className='absolute w-full mt-2 bg-white border border-gray-200 rounded-xl shadow-xl z-50 max-h-60 overflow-y-auto overflow-x-hidden'
                                >
                                    {experienceLevels.map((level, index) => (
                                        <div
                                            ...
                                            className='px-6 py-3 hover:bg-green-50 hover:text-green-700 cursor-pointer transition text-sm text-gray-700 border-b border-gray-50 last:border-none'
                                        >
                                            {level}
                                        </div>
                                    ))}
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center justify-center space-y-3">
                                    <motion.div
                                        ...
                                        className="bg-green-100 p-2.5 rounded-full group-hover:bg-green-200 transition-colors"
                                    >
                                        <FaCloudUploadAlt className="text-3xl text-green-600" />
                                    </motion.div>

                                    <div className="text-center">
                                        <h3 className="text-base font-semibold text-gray-800">Upload Resume</h3>
                                        <p className="text-gray-500 text-xs mt-0.5">Drag & drop your PDF here</p>
                                        <p className="text-gray-400 text-[10px] mt-1 italic">PDF only (Max 5MB)</p>
                                    </div>
                                    ...
                                    {analyzing ? (
                                        <div className="flex items-center gap-2 bg-gray-900 text-white px-6 py-2 rounded-lg shadow-lg">
                                        ...
                                        <button
                                            ...
                                            className="bg-white border border-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition shadow-sm font-medium text-xs flex items-center gap-2 group-hover:scale-105"
                                        >
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-green-600 text-sm truncate mt-1">
                                    ...
                                    <button
                                        ...
                                        className="text-xs bg-white border border-green-200 text-green-700 px-3 py-2 rounded-lg hover:bg-green-100 transition font-bold"
                                    >
                                        Change Resume
                                    </button>
                                </div>
                                        ...
                                        <div className="bg-white/50 rounded-xl p-4">
                                            ...
                                            <ul className="grid grid-cols-1 gap-1">
                                                {projects.slice(0, 3).map((p, i) => (
                                                    <li key={i} className="text-xs text-gray-600 truncate bg-white border border-gray-100 px-3 py-2 rounded-lg">• {p}</li>
                                                ))}
                                            </ul>
                                        </div>
                                    )}
                                        ...
                                        <div className="bg-white/50 rounded-xl p-4">
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {skills.slice(0, 6).map((s, i) => (
                                                    <span key={i} className="bg-white border border-green-100 text-green-700 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider">{s}</span>
                                                ))}
                                            </div>
                                        </div>
                                    )}
                        ...
                        <motion.button
                            ...
                            className={`w-full py-4 rounded-xl text-lg font-bold transition-all duration-300 shadow-md flex items-center justify-center gap-2 relative z-50 
                                ${loading 
                                    ...
                                    : 'bg-gray-700 text-white hover:bg-green-600 hover:shadow-xl cursor-pointer'
                                }`}
                        >
                            {loading ? (
                                <>
